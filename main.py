...
fig3.add_trace(go.Scatter(x = data_dates.index , y = data_dates["Cumulative_deaths"], fill = "tonexty", line_color = "green"))
fig3.update_layout(title = "Cumulative Deaths Worldwide")
fig3.write_html("Fig3.html", auto_open = True)

fig4 = go.Figure()

fig4.add_trace(go.Scatter( x = data_dates.index, y = data_dates["New_deaths"], fill = "tonexty", line_color = "orange"))
